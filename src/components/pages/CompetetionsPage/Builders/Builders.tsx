...
const Builders: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative bg-nero flex flex-col items-start justify-center p-5 box-border gap-[20px] text-left text-4xl text-nero font-body-large-600 sm:py-[30px] sm:px-[5px] sm:box-border">
      ...
      <div className="self-stretch flex flex-row items-start justify-center gap-[20px] relative z-[1] text-md text-black1 lg:flex-col md:flex-col">
        ...
        <div className="self-stretch flex-1 flex flex-row items-start justify-center z-[0] text-2xl lg:w-full lg:flex-[unset] lg:self-stretch md:flex-[unset] md:self-stretch">
