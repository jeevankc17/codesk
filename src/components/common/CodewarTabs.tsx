...
const CodewarTabs: FunctionComponent<CodewarTabsType> = ({
  ...
  return (
    <div
      className={`self-stretch h-[65px] rounded-lg bg-footer-header flex flex-row flex-wrap items-start justify-center py-2.5 px-0 box-border gap-[5px] sticky top-[77] z-[3] text-center text-lg text-aqua-deep font-body-large-600 sm:pl-0 sm:pr-0 sm:box-border ${className}`}
    >
      <button
