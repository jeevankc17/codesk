...
const CurriculumByCoursePage: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative bg-nero flex flex-col items-start justify-center p-5 box-border gap-[20px] text-left text-base text-black font-body-medium-400 sm:pl-[5px] sm:pr-[5px] sm:box-border">
      <Navbar
        logoColor="#1f95f2"
          ...
          <div className="self-stretch w-[521px] flex flex-row items-start justify-center sticky top-[70] z-[0] text-sm font-inter lg:self-stretch lg:w-full lg:order-[1]">
            <div className="flex-1 shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded bg-nero flex flex-col items-center justify-center p-2.5 sticky gap-[15px] top-[70] lg:flex-1">
              ...
              <div className="self-stretch bg-nero flex flex-col items-start justify-start gap-[5px] z-[1]">
                ...
                <div className="self-stretch flex flex-col items-center justify-center pt-0 px-0 pb-2 text-center text-dodger-blue font-body-medium-400">
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[5px] z-[2] text-lg font-body-medium-400">
      ...
      <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[15px] z-[1] text-center text-13xl font-inter">
        <div className="self-stretch bg-nero flex flex-col items-center justify-center py-0 px-[5px] gap-[5px]">
          ...
          <div className="self-stretch flex flex-row items-center justify-center py-2.5 px-[50px] text-xl font-body-medium-400">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-center justify-center p-5 gap-[50px] text-left text-5xl text-aqua-deep font-body-medium-400 sm:pl-[5px] sm:pr-[5px] sm:box-border">
          ...
          <div className="w-[471px] bg-nero flex flex-col items-center justify-center p-2.5 box-border gap-[10px] text-center text-black">
            ...
            <div className="self-stretch flex flex-row flex-wrap items-center justify-center gap-[10px] text-base">
              ...
              <div className="w-[200px] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded bg-nero flex flex-col items-center justify-start p-[15px] box-border gap-[15px] text-sm">
                <img
                  className="w-[50px] relative h-[50px] overflow-hidden shrink-0"
                  alt=""
                  src="/wechatlogo.svg"
              ...
              <div className="w-[200px] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded bg-nero flex flex-col items-center justify-start p-[15px] box-border gap-[15px] text-left text-sm">
                <img
                  className="w-[50px] relative h-[50px] overflow-hidden shrink-0"
                  alt=""
                  src="/wechatlogo.svg"
              ...
              <div className="w-[200px] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded bg-nero flex flex-col items-center justify-start p-[15px] box-border gap-[15px]">
                ...
                />
                <div className="self-stretch flex flex-row items-start justify-center">
                  <div className="flex-1 relative leading-[150%]">Hosting</div>
                </div>
              </div>
            </div>
          </div>
