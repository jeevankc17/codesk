...
const AboutUsPage: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative bg-nero flex flex-col items-center justify-start p-5 box-border gap-[20px] text-center text-13xl text-aqua-deep font-body-medium-600 sm:pl-[5px] sm:pr-[5px] sm:box-border">
      <Navbar
        logoColor="#1f95f2"
      ...
      <div className="w-[1380px] bg-nero hidden flex-col items-center justify-center gap-[15px] z-[4] text-black font-inter">
        <div className="self-stretch bg-nero flex flex-col items-center justify-center py-0 px-[5px] gap-[5px]">
          ...
          <div className="self-stretch flex flex-row items-center justify-center p-2.5 text-xl text-dimgray font-body-medium-600">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-center justify-center p-[15px] gap-[15px] text-base font-body-medium-600 md:flex-row md:flex-wrap">
      ...
      <div className="self-stretch bg-nero flex flex-col items-center justify-center py-0 px-[5px] gap-[5px] z-[3] font-inter">
        ...
        <div className="self-stretch flex flex-row items-center justify-center text-xl text-black font-body-medium-600">
      ...
      <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[15px] z-[2]">
        ...
        <div className="self-stretch bg-nero flex flex-col items-start justify-start p-[15px] gap-[40px] text-9xl text-black">
      ...
      <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[15px] z-[1]">
        ...
        <div className="self-stretch bg-nero flex flex-col items-start justify-start p-[15px] gap-[40px] text-9xl text-black font-inter">
            ...
            <div className="flex-1 flex flex-col items-center justify-center py-0 px-[70px] lg:flex-[unset] lg:self-stretch md:pl-2.5 md:pr-2.5 md:box-border md:flex-[unset] md:self-stretch">
              <div className="self-stretch flex flex-col items-start justify-start w-full">
                <div className="self-stretch flex flex-col items-start justify-start">
                  ...
                  <div className="self-stretch bg-nero flex flex-row items-center justify-center p-2.5 text-base font-body-medium-600">
                    <div className="flex-1 relative leading-[150%] font-medium">
                      (April 2022)
                    </div>
                  </div>
                </div>
                <div className="self-stretch bg-nero flex flex-row items-center justify-center py-2.5 px-[30px] text-base font-body-medium-600">
                  <div className="flex-1 relative leading-[150%]">
          ...
          <div className="self-stretch bg-nero flex flex-row items-center justify-between font-body-medium-600 lg:flex-col md:flex-col">
