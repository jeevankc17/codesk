  ...
  return (
    <>
      <div className="w-full relative bg-nero flex flex-col items-start justify-center p-5 box-border gap-[20px] text-center text-13xl text-black1 font-body-large-600 sm:py-[30px] sm:px-[5px] sm:box-border">
        <div className="self-stretch h-[77px] flex flex-row items-start justify-start z-[6]">
                ...
                <div className="flex-1 flex flex-col items-end justify-center py-8 px-0 lg:order-[2] lg:flex-[unset] lg:self-stretch md:flex-[unset] md:self-stretch">
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start text-lg text-black1">
                    <div className="self-stretch relative leading-[150%]">
                      ...
                      <p className="m-0">
                        serious ventures a place to breathe, invite
                        collaborators and
                      </p>
                ...
                <div className="flex-1 flex flex-col items-start justify-center py-8 px-0 lg:flex-[unset] lg:self-stretch md:flex-[unset] md:self-stretch">
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start text-lg text-black1">
                    <div className="self-stretch relative leading-[150%]">
                      ...
                      <p className="m-0">
                        a button. We save all the required info so that you
                        don’t
                      </p>
                      <p className="m-0">
          ...
          <div className="self-stretch bg-nero flex flex-row flex-wrap items-center justify-center p-[15px] gap-[15px] text-base md:flex-row md:flex-wrap">
            ...
            <div className="w-[350px] rounded-3xs bg-nero flex flex-col items-center justify-center p-5 box-border">
              ...
              <div className="self-stretch bg-nero flex flex-col items-center justify-center">
                ...
                <div className="self-stretch flex flex-col items-center justify-center text-sm">
                  <div className="w-full relative leading-[150%] inline-block max-w-[448px]">
                    Coding challenges in hackathons push children to think
                    outside the box and come up with creative solutions. They
                    learn to break down complex problems into manageable chunks
                    and use their coding knowledge to devise innovative
                    approaches.
                  </div>
                </div>
              </div>
            ...
            <div className="w-[350px] rounded-3xs bg-nero flex flex-col items-center justify-center p-5 box-border">
              ...
              <div className="self-stretch bg-nero flex flex-col items-center justify-center">
                ...
                <div className="self-stretch flex flex-col items-center justify-center text-sm">
                  <div className="w-full relative leading-[150%] inline-block max-w-[448px]">
                    Many hackathons encourage teamwork, where children
                    collaborate on coding projects. This teaches them how to
                    work efficiently in a team setting, manage version control
                    systems like Git, and leverage tools like GitHub for
            ...
            <div className="shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] rounded-13xl bg-nero overflow-hidden flex flex-col items-center justify-start py-10 px-5 gap-[28px]">
              ...
              <div className="w-[317.3px] flex flex-col items-center justify-start py-0 px-[20.6px] box-border text-sm">
                <div className="self-stretch relative leading-[150%]">
                  ...
                  students, or professionals. Organizers may also require
                  parental consent for participants under a certain age.
                </div>
              </div>
            </div>
            <div className="shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] rounded-13xl bg-nero overflow-hidden flex flex-col items-center justify-start py-10 px-5 gap-[28px]">
              ...
              <div className="w-[317.3px] flex flex-col items-center justify-start py-0 px-[20.6px] box-border text-sm">
                <div className="self-stretch relative leading-[150%]">
                  ...
                  skills. Organizers often provide information about the
                  required skill level in the event's description or
            ...
            <div className="shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] rounded-13xl bg-nero overflow-hidden flex flex-col items-center justify-start py-10 px-5 gap-[28px]">
              ...
              <div className="w-[317.3px] flex flex-col items-center justify-start py-0 px-[20.6px] box-border text-sm">
                <div className="self-stretch relative leading-[150%]">
                  ...
                  advance, either individually or as part of a team.
                  Registration requirements may include providing personal
                  information, such as name, email address, and sometimes
                  educational or professional background. In some cases,
                  participants may need to submit a brief application or answer
                  questions about their coding experience or project ideas.
                </div>
              </div>
            </div>
          </div>
